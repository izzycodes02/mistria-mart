                      ...
                      <td className="px-3 py-3 sticky right-0 bg-inherit z-20">
                        <div
                          ...
                          onClick={(e) => {
                            ...
                            e.preventDefault();
                            setOpenActionsRowId(
                              openActionsRowId === rowIndex ? null : rowIndex,
                            );
                          }}
                        >
                          <IconDotsVertical className="w-4 h-4 text-gray-500 hover:text-gray-700" />
                          {openActionsRowId === rowIndex && (
                            <div className="absolute -left-26 -top-1 w-fit bg-white border border-gray-200 rounded shadow-md z-20">
                              {actions(row)}
                            </div>
                          )}
                        </div>
          ...
          <div className="flex items-center justify-between mt-4 flex-wrap gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex gap-2">
                ...
                <span className="px-3 py-1 text-sm bg-white rounded">
